...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botao.setOnClickListener{
            lancarDados(texto, grupoDeDados, imagem)
        }
    }

    private fun lancarDados(texto : TextView, grupoDeDados : ChipGroup, imagem : ImageView){
